 ...
 **Description**: The App is meant for users to save books into their virtual library and mark them as 'read' or 'not read'. Once a user enters the name of a book, an API call is made to 'Google Books API' to get and display the thumbnail picture to the user. The app was built using Javascript, HTML, and CSS. A Single Sign-On Method was implemented through Google's FireBase, and the user data is saved in a NoSQL database using Firebase's Realtime Database.
